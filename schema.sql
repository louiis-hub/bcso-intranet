...
INSERT INTO grades (nom, abrev, ordre) VALUES
  ...
  ('Deputy I',     'DEP I',  2),
  ('Deputy II',    'DEP II', 3),
  ('Deputy III',   'DEP III',4),
  ('Senior Deputy','S.DEP',  5),
  ('Sergeant I',   'SGT I',  6),
  ('Sergeant II',  'SGT II', 7),
  ('Lieutenant I', 'LT I',   8),
  ('Lieutenant II','LT II',  9),
  ('Captain',      'CPT',   10),
  ('Undersheriff', 'U.SHRFF',11),
  ('Sheriff',      'SHRFF', 12)
...
INSERT INTO units (code, nom, description) VALUES
  ...
  ('PRD',  'Patrol Response Division',   'Patrouille générale et premier engagement.')
